...
def sugar_sugar_read(): 
    ...
    sug_sug_output_file = "1.2_output_{}.txt".format(output_format) #If you wanted to change the name of the output file do it here.
                                ...
                                if concated_sugar_1 in value['Sugars']:
                                    if concated_sugar_2 in value['Sugars']:
                                        if output_format == 'json':
                                            ...
                                            output_data.append([pdb_code,sugar_name_1,sugar_name_2,sugar_chain_1,position_1,position_2,entry[2],entry[3],res,q,phi,theta,rscc_1,rscc,detectedType,cnf,mFo,Bfac])
                                        else:
