...
def sugar_sugar_read(): 
    ...
    if reduced_output == False:
        sug_sug_output_file = "6_sug_sug_output_{}.txt".format(output_format) #If you wanted to change the name of the output file do it here.
    else:
...
def residue_sugar_read():
    ...
    if reduced_output == False:
        res_sug_output_file = "6_res_sug_output_{}.txt".format(output_format) #If you wanted to change the name of the output file do it here
    else:
