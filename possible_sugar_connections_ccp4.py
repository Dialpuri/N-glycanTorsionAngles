               ...
               # if sugar_chain_position[0] == sugar_name:
                if sugar_chain_position[1] == sugar_chain:
                    if int(sugar_chain_position[2]) == (int(sugar_number) + 1):
                        print("Potential Joined Chains found \n PDB CODE: {}, Sugars: {} and {}, Chain: {}, Numbers:{} and {}".format(pdb_code, sugar_name, sugar_chain_position[0], sugar_chain_position[1], sugar_number, sugar_chain_position[2]))
